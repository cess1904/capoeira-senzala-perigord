...
<div class="container">
    ...
    <div class="header">
        ...
        <p>Créez une nouvelle page pour le site.</p>
    </div>
    ...
    >
        ...
        <div class="form-group">
            ...
            <textarea
                id="content"
                name="content"
                placeholder="Écrivez ici le contenu de la page..."
        ...
        <div class="seo-box">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('seo_title') }}"
                    maxlength="60"
                    placeholder="Ex : Capoeira à Périgueux | Senzala do Périgord"
                >
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    maxlength="160"
                    placeholder="Décrivez brièvement cette page pour Google..."
