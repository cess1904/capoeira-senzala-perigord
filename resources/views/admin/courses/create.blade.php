...
<body>
  ...
  <div class="container">
    ...
    <form action="{{ route('admin.courses.store') }}" method="POST" class="form-card">
      @csrf
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" id="city" name="city" placeholder="Ex : Périgueux" required>
        </div>

        <div class="form-group">
          <label for="venue">Lieu / complexe</label>

          <input type="text" id="venue" name="venue" placeholder="Ex : Complexe de la Filature de l'Isle" required>
        </div>

        <div class="form-group">
          <label for="room">Salle</label>

          <input type="text" id="room" name="room" placeholder="Ex : Salle n°1">
        </div>
        ...
        <div class="form-group full-width">
          ...
          <textarea id="notes" name="notes" placeholder="Ex : Musique et chant, entrée sur la droite..."></textarea>
        </div>
      ...
      <div class="actions">
        ...
        <a href="{{ route('admin.courses.index') }}" class="back-button">
          Annuler
        </a>
